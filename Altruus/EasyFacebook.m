...
+ (EasyFacebook *)sharedEasyFacebookClient
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        //Default settings
        _sharedEasyFacebookClient.readPermissions = @[@"public_profile", @"email", @"user_friends", @"user_birthday"];
...
{
    //NSMutableDictionary* parameters = [NSMutableDictionary dictionary]; //COMENTE 260517
    //[parameters setValue:@"id, name, email, first_name, gender, last_name, locale, timezone" forKey:@"fields"];
